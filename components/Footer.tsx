...
const Footer = () => {
  return (
    <footer className="w-full pt-20 pb-10" id="contact">
        ...
        <a href="mailto:uditshukla731@gmail.com">
            <MagicButton title="Let's get in touch" icon={<FaLocationArrow/>} position="right"/>
        </a>
        </div>
        <div className="flex mt-16 md:flex-row flex-col justify-between items-center"><p className="md:text-base text-sm md:font-normal font-light">Copyright © 2024 Udit</p>
