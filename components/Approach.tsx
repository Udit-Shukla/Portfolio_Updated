  ...
  return (
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center  gap-4 ">
        ...
        <Card title="Development and Progress update" icon={<AceternityIcon order="Phase 2" />} description="We'll collaborate to map out your website's goals, target audience,, and key functionalities. We'll discuss things like site structure, navigation, and content requirements.">
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card title="Development and Launch" icon={<AceternityIcon order="Phase 3" />} description="We'll collaborate to map out your website's goals, target audience,, and key functionalities. We'll discuss things like site structure, navigation, and content requirements.">
          <CanvasRevealEffect
            animationSpeed={3}
